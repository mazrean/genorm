...
func TestAssignLit(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		expr1Args   []genorm.ExprType
		expr1Errs   []error
		lit         genorm.WrappedPrimitive[int]
		expected    *genorm.TableAssignExpr[*mock.MockTable]
		isError     bool
	}{
		{
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.AssignLit(expr1, test.lit)
...
func TestEqLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.EqLit(expr1, test.lit)
...
func TestLeqLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.LeqLit(expr1, test.lit)
...
func TestGeqLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.GeqLit(expr1, test.lit)
...
func TestLtLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.LtLit(expr1, test.lit)
...
func TestGtLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.GtLit(expr1, test.lit)
...
func TestInLit(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.description, func(t *testing.T) {
			...
			res := genorm.InLit(expr1, test.lits...)
